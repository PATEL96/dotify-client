		...
		<div className="h-[10svh] text-2xl font-bold flex items-center justify-between sticky top-0 w-full bg-[#fffff66] z-10 backdrop-blur-sm ">
			...
			<div className="m-3 flex items-center justify-evenly gap-5">
				...
				<div className="flex md:hidden items-center gap-4">
					<a href="https://github.com/PATEL96" target="_blank" rel="noopener noreferrer" aria-label="Follow @PATEL96 on GitHub">
						<Github size={24} className="text-neutral-300 transition-colors" />
					</a>
					<a href="https://github.com/PATEL96/dotify-client" target="_blank" rel="noopener noreferrer" aria-label="Star PATEL96/dotify-client on GitHub">
						<Star size={24} className="text-yellow-500 transition-colors" />
					</a>
					<a href="https://github.com/sponsors/PATEL96" target="_blank" rel="noopener noreferrer" aria-label="Sponsor @PATEL96 on GitHub">
						<Heart size={24} className="text-pink-500 transition-colors" />
					</a>
				</div>
